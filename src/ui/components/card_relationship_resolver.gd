...
const RELATED_CARD_OPS := ["summon_from_effect", "generate_card_to_hand", "generate_card_to_deck", "fill_lane_with", "summon_copies_to_lane", "equip_generated_item", "transform"]
